...
Organizations whose employees work multiple shifts need to schedule sufficient workers 
for each daily shift. Typically, the schedules will have constraints, such as "no employee 
should work two shifts in a row". Finding a schedule that satisfies all constraints can be 
computationally difficult.

The following sections present an example of an employee scheduling problem, and show how 
to solve it using the CP-SAT solver.
